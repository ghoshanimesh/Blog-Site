    ...
    <table class="table table-bordered table-hover">
        ...
        <?php   
            ...
            while($row = mysqli_fetch_assoc($select_all_comments_query)){
                ...
                echo "<td><a class='btn btn-success' href='comments.php?approve=$comment_id'><span class='fa fa-check'> Approve</span></a></td>";
                
                echo "<td><a class='btn btn-warning' href='comments.php?unapprove=$comment_id'><span class='fa fa-times'> Unapprove</span></a></td>";      
                
                echo "<td><a class='btn btn-danger' href='comments.php?delete=$comment_id'><span class='fa fa-trash'> Delete</span></a></td>";
