<!-- Navigation -->
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php">Blog CPanel</a>
            </div>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    ?>
                     <li <?php if($page == "users") echo"class='active'";?>>
                        <a href="javascript:;" data-toggle="collapse" data-target="#user-menu"><i class="fa fa-fw fa-arrows-v"></i> Users <i class="fa fa-fw fa-caret-down"></i></a>
